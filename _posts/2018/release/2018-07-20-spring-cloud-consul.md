...
](https://hunzino1.github.io/springcloud/2017/05/10/springcloud-eureka.html)，本篇文章主要给大家介绍 Spring Cloud Consul 的使用。
...
![](https://hunzino1.github.io/assets/images/2018/springcloud/consul-server-client.png)

**Consul 工作原理：**

![](https://hunzino1.github.io/assets/images/2018/springcloud/consol_service.png)
...
![](https://hunzino1.github.io/assets/images/2018/springcloud/consul_insall.png)


我这里以 Windows 为例，下载下来是一个 consul_1.2.1_windows_amd64.zip 的压缩包，解压是是一个 consul.exe 的执行文件。

![](https://hunzino1.github.io/assets/images/2018/springcloud/consul_win.png)
...
![](https://hunzino1.github.io/assets/images/2018/springcloud/consol_cmd.png)

启动成功之后访问：`http://localhost:8500`，可以看到 Consul 的管理界面

![](https://hunzino1.github.io/assets/images/2018/springcloud/consol_manage.png)
...
![](https://hunzino1.github.io/assets/images/2018/springcloud/consol_producer.png)

我们发现页面多了 service-producer 服务，点击进去后页面显示有两个服务提供者：

![](https://hunzino1.github.io/assets/images/2018/springcloud/consol_producer-2.png)
