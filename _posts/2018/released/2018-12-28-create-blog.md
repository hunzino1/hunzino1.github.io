...
> 此文是基于纯洁的微笑博主《技术人如何搭建自己的技术博客》扩展，在此感谢
...
1、首先打开地址[https://github.com/hunzino1/hunzino1.github.io](https://github.com/hunzino1/hunzino1.github.io)，点击 Fork 按钮将代码复制一份到自己的仓库。
...
> _config文件之所以要单独说，是因为这块涉及到几个重要的操作：
>    1、博客树（会在后续说明）
>    2、博客路径
>    3、评论系统
>这里只讲部署，目的就是能用即可。
...
专题系列博客会有一个博客树，导航栏的展示配置是在config文件中。
具体配置见博客树专题；
...
这时候在访问地址： `https://github_username.github.io`，就会发现博客就已经构建完成了。

3、评论系统

博客是支持评论的，用的disqus, gitment, gitalk，效果如下：

![](https://hunzino1.github.io/assets/images/2018/create_blog/layouts.png)

config文件配置如下：

![](https://hunzino1.github.io/assets/images/2018/create_blog/oauth.png)

- 1、账户名是github用户名;

- 2、repo: 需要见一个空的repository,用来存储评论信息(仓库名)
...
- 2、pages目录配置ruby-tree.md节点

![](https://hunzino1.github.io/assets/images/2018/create_blog/page.png)

- 3、includes下添加ruby-tree.html节点

    设置post.category=='rubytree'

- 4、新增blog设置

    新建一个blog时，绑定rubytree节点；
![](https://hunzino1.github.io/assets/images/2018/create_blog/blog.png)
